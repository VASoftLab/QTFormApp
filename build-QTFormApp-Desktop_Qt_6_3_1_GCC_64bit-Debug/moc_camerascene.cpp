...
#include <memory>
#include "../QTFormApp/camerascene.h"
...
struct qt_meta_stringdata_CameraScene_t {
    const uint offsetsAndSize[2];
    char stringdata0[12];
};
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_CameraScene_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_CameraScene_t qt_meta_stringdata_CameraScene = {
    {
QT_MOC_LITERAL(0, 11) // "CameraScene"
...
const QMetaObject CameraScene::staticMetaObject = { {
    ...
    qt_meta_stringdata_CameraScene.offsetsAndSize,
    qt_meta_data_CameraScene,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_CameraScene_t
...
void *CameraScene::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CameraScene.stringdata0))
